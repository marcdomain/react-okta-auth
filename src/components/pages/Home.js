...
export default withAuth(class Home extends Component {
  ...
  render() {
    ...
    const mainContent = this.state.authenticated ? (
      <div>
        <p className='lead'>You are logged in. <Link to='/staff'>Click here</Link> to visit your portal</p>
        <button className='btn btn-light btn-lg' onClick={this.logout}>Logout</button>
      </div>
    ) : (
      <div>
        <p className='lead'>If you're a staff member, please get your credentials from your supervisor</p>
